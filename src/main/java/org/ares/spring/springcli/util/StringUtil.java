...
public class StringUtil {
    ...
    public static String addCommandLabel(String className) {
        return !className.contains("Command") ? StringUtils.capitalize(className) + "Command" : className;
    }
    ...
    public static String addCommandGroupLabel(String className) {
        String x = !className.contains("CommandGroup") ? StringUtils.capitalize(className) + "CommandGroup" : className;
